...
namespace sd_client
{
    public partial class Form1 : Form
    {
        ...
        private async Task<int> longRun()
        {
        ...
        {
            /*string log = simpledrive.login("simpledrive.org/demo", "demo", "demo");
            MessageBox.Show("login: " + log);
            simpledrive.sync("simpledrive.org/demo", "demo", "demo", userdir);
            return;*/
            if (!canReadConfig())
            {
                status.Text = "Config not found";
        ...
        private void sync_folder_Click(object sender, EventArgs e)
        {
